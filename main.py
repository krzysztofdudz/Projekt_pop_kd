...
class chargingstation:
    def _init_(self, chargingstation_name, chargingstation_location, ):
        self.chargingstation_name = chargingstation_name

        self.chargingstation_location = chargingstation_location
    ...
    def get_coordinates(self) -> list:
        ...
        url = f"https://pl.wikipedia.org/wiki/{self.chargingstation_location}"
